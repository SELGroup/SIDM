...
register(
        id='FetchStacking-v0',
        entry_point='rl.envs.envs:FetchStackingEnv',
...
register(
        ...
        entry_point='rl.envs.envs:FetchPlaceEnv',
...
register(
        id='FetchCleanUp-v0',
        entry_point='rl.envs.envs:FetchCleanUpEnv',
...
register(
        ...
        entry_point='rl.envs.envs:FetchSlipperyPushEnv',
...
register(
        id='FetchHook-v0',
        entry_point='rl.envs.fetch_hook_env:FetchHookEnv',
        timestep_limit=100,
    )

register(
    id='FetchComplexHook-v0',
    entry_point='rl.envs.complex_hook_env:ComplexHookEnv',
    timestep_limit=100,
)

register(
    id='ComplexHookSingleObject-v0',
    entry_point='rl.envs.complex_hook_env:ComplexHookSingleObjectEnv',
    timestep_limit=100,
)
